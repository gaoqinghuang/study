<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"F:\PHP\wampserver\wamp\www\blog\public/../application/admin\view\link\edit.html";i:1499677570;s:74:"F:\PHP\wampserver\wamp\www\blog\public/../application/admin\view\base.html";i:1501037018;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="link_name"  class="form-control" placeholder="请填写友链名称" value="<?php echo $oldData['link_name']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="link_url"  class="form-control" placeholder="" value="<?php echo $oldData['link_url']; ?>">
                            </div>
                        </div>
