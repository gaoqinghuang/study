<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"F:\PHP\wampserver\wamp\www\blog\public/../application/admin\view\tag\index.html";i:1499240126;s:74:"F:\PHP\wampserver\wamp\www\blog\public/../application/admin\view\base.html";i:1501037018;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="<?php echo url('store',['tag_id'=>$vo['tag_id']]); ?>">编辑</a></li>
                                            <li class="divider"></li>
                                            <li><a href="<?php echo url('del',['tag_id'=>$vo['tag_id']]); ?>">删除</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
