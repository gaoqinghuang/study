<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"F:\PHP\wampserver\wamp\www\blog\public/../application/admin\view\article\store.html";i:1499932190;s:74:"F:\PHP\wampserver\wamp\www\blog\public/../application/admin\view\base.html";i:1501037018;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
...
<div class="container-fluid admin_menu">
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9 col-lg-10">
            ...
            <form class="form-horizontal" id="form"  action="<?php echo url('admin/article/store'); ?>" method="post" enctype="multipart/form-data">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" name="arc_content"  class="form-control" placeholder=""></textarea>
                            </div>
                        </div>
                    </div>
                </div>
