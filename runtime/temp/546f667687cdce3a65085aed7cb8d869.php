<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"F:\PHP\wampserver\wamp\www\blog\public/../application/admin\view\link\index.html";i:1499679959;s:74:"F:\PHP\wampserver\wamp\www\blog\public/../application/admin\view\base.html";i:1501037018;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8"/>
                    ...
                    <div class="panel-body">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo $vo['link_sort']; ?></td>
                                <td>
                                    <div class="btn-group">
                                        <button data-toggle="dropdown" class="btn btn-primary btn-xs dropdown-toggle">操作 <span class="caret"></span></button>
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="<?php echo url('edit',['link_id'=>$vo['link_id']]); ?>">编辑</a></li>
                                            <li class="divider"></li>
                                            <li><a href="<?php echo url('del',['link_id'=>$vo['link_id']]); ?>">删除</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
