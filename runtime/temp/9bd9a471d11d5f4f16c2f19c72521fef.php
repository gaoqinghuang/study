<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"F:\PHP\wampserver\wamp\www\blog\public/../application/index\view\index\index.html";i:1503501332;s:74:"F:\PHP\wampserver\wamp\www\blog\public/../application/index\view\base.html";i:1500603491;}*/ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="__STATIC__/index/css/index2.css" />
	...
	<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	  ...
	  <div class="carousel-inner" role="listbox">
	    <div class="item active">
	      <img src="__STATIC__/index/images/111.jpg">
	    </div>
	    <div class="item">
	       <img src="__STATIC__/index/images/222.jpg">
	    </div>
	  </div>
...
<?php if(is_array($articleData) || $articleData instanceof \think\Collection || $articleData instanceof \think\Paginator): if( count($articleData)==0 ) : echo "" ;else: foreach($articleData as $k=>$vo): ?>
<article>
	<div class="_head">
...
<!-- 	<img src="F:\PHP\wampserver\wamp\www\blog\public\static\index\images\文本元素1.png"  class="img-responsive"/> -->
		<p>
	...
	<div class="_footer">
		...
		<?php if(is_array($article[$k]['tags']) || $article[$k]['tags'] instanceof \think\Collection || $article[$k]['tags'] instanceof \think\Paginator): if( count($article[$k]['tags'])==0 ) : echo "" ;else: foreach($article[$k]['tags'] as $key=>$v): ?>
						...
						<div class="_widget">
							...
							<div class="_info">
								...
								<p>
									...
									<a href="http://www.tp5.com/" target="_blank">小高博客</a>
								</p>
							</div>
						</div>
						<div class="_widget">
				...
				<div class="row">
					<div class="col-sm-4">
						...
						<div id="" class="_single">
							...
							<time><?php echo date('Y-d-m H:i:s',$vo['sendtime']); ?></time>
						</div>
						<?php endforeach; endif; else: echo "" ;endif; ?>
					</div>
